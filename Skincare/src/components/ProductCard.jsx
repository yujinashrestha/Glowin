...
function ProductCard({ product }) {
  ...
  return (
    <div className="relative w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl cursor-pointer mt-10">
      {/* Wishlist Icon */}
      <div
      ...
      >
        {isWishlisted ? (
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="red" className="bi bi-heart-fill" viewBox="0 0 16 16">
  ...
  className="bg-transparent border-none p-0 m-2.5 focus:outline-none appearance-none text-gray-400 hover:text-white transition-colors duration-200"
  aria-label="Toggle Description"
>
  {showDesc ? (
    // Up arrow (thin chevron)
    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M5 15l7-7 7 7" />
    </svg>
  ) : (
    // Down arrow (thin chevron)
    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" />
            ...
            <svg
              ...
              className="bi bi-bag-plus text-gray-700 hover:text-black"
              viewBox="0 0 16 16"
            >
